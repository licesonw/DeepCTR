...
target = to_categorical(data['rating'])
...
model = DeepFM(linear_feature_columns,dnn_feature_columns,task='multiclass', output_dim=target.shape[1])

model.compile("adam", "sparse_categorical_crossentropy", metrics=['accuracy'], )
history = model.fit(model_input, target,
